...
Objects can be a single piece of data (e.g. my_number <- 24), or they can consist of structured data. The graphic below shows some common data structures and their names. Not included in this image is spatial data, which is discussed in another page.  
