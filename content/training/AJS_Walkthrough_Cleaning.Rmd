...
**In this template section you choose from three code chunks for importing your dataset, depending on the type of dataset you have.**  

If you have a dataset that originated as an export from MSF's DHIS2 system and is standardized to the MSF data dictionary for the template's disease, you use one of the first two code chunks, either:
- either the code chunk for a DHIS2 CSV (.csv) file, or a DHIS2  or  
