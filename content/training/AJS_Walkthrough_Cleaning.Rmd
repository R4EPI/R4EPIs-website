...
This code creates two vectors of variable names - one for symptoms and one for laboratory testing. In a previous step we assigned our dataset variables to standard data dictionary variables and so we can use this code from the template.  
