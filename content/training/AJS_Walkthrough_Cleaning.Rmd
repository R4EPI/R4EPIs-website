...
You can either:  
* Enter the counts directly **[need clarification here as this is not yet built]**  
* Use the function gen_population() to derive the counts from proportions  
* Import a spreadsheet file with the counts in the correct format  

![](/images/Population_Counts.png)  
