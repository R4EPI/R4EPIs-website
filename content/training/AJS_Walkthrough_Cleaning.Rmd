...
Please review the [sitrep wiki page](https://github.com/R4EPI/sitrep/wiki/1)-Getting-started) for instructions on the following start-up steps:  
...
Now, slightly out-of-order, we can make the DIED variable (which is referenced in later code).  
