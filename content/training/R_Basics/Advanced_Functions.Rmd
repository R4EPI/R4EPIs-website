...
## Making beautiful graphics with the **ggplot2** package and `ggplot()`  


R has the capability to make beautiful, very tailored graphics using the package **ggplot2** and its function `ggplot()`. Below is a brief overview of the use of `ggplot()`. You can read in more depth in this tutorial TODO. Also, reviewing [this gallery of visualizations and extensions](http://www.ggplot2-exts.org/gallery/) can be helpful and inspirational.  

You can also download [this ggplot2() cheatsheet](/public_data/ggplot2-cheatsheet.pdf).  
