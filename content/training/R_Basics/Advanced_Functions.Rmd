...
R has the capability to make beautiful, very tailored graphics using the package **ggplot2** and it's function `ggplot()`. Below is a brief overview of the use of `ggplot()`, and you can read in more depth in this tutorial TODO. Reviewing [this gallery of visualizations](http://www.ggplot2-exts.org/gallery/) and `ggplot()` extensions can also be helpful and inspirational.  
