...
* **Text that appears GREEN in the RMarkdown will not appear in the final report**. These sections, placed between special arrows (known as html comment tags, `<!-- -->`), serve as instructions for you.  
