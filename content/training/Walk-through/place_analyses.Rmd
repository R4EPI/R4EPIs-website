...
TODO: Here are the basics about shapefile, you can read more HERE. diferent parts are read together. 
...
TODO: Note when using here() list the .shp filename.

```{r read_shapefiles, message=FALSE}
## reading in a shapefile 
map <- read_sf(here("mapfolder", "quartiersshape.shp"))
