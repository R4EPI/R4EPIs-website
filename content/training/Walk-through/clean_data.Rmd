...
Tip: One variable (test_hepatitis_e_igm) has values 0 and 1 that we want to change to "Positive" and "Negative". The fct_record() function expects *character* RHS inputs (within quotes) - so put "0" and "1" in quotes, as below, and confirm the change.
