...
After knitting, you may see warning text in your final report. Typically, it is recommended that you attempt to fix the code that produced the error (see the R Basics - [Errors and Warnings](https://r4epis.netlify.com/training/r_basics/errors_and_warnings/) page. However, sometimes you may want to ignore the warning and have it not appear in the report.  
