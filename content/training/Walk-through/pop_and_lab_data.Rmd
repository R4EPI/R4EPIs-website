...
**If you choose not to complete the population estimates section at all, delete or comment (#) all default `gen_population()` code, and expect that later sections on attack and mortality rates will not produce output.**
