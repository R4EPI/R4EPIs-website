...
{{% notice tip %}}
It is necessary to use the "full name" of variables for this to work correctly - this means `date_of_onset` should be listed in `incidence()` as `linelist_cleaned$date_of_onset`. Otherwise you may get an error such as "object 'date_of_onset' not found".
{{% /notice %}}
...
{{% notice tip %}}
Remember that if listing a variable, the plot() function expects its "full name", such as `linelist_cleaned$sex`**. Otherwise you may get an error such as "object 'sex' not found". 
{{% /notice %}}
